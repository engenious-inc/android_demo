...
class BucketPresenterTest {
    ...
    @Mock
    lateinit var view: BucketFragmentView

    lateinit var presenter: BucketPresenter
    ...
    fun setupPresenter() {
        ...
        presenter = Whitebox.newInstance(BucketPresenter::class.java).also {
            Whitebox.setInternalState(it, "placeId", placeId)
            it.bind(view)
        }
    }
    ...
    fun minusButtonDoesntDecreaseCountBelowZero() {
        ...
        verify(view, times(1)).refreshTotal()
    }
